        ...
        <div class="container">
            <div class="row">
                <div class="col m-5 p-5 text-center">
                    <h1 class="white m-4 p-4">Welcome to Paiment, A better way to send Money</h1>
                    <p class="white">Send money with a better exchange rate and avoid excessive bank fees.</p>
                  <a href="transactions.php"><button type="button" class="btn btn-outline-primary p-2 m-3 w-50">Transfer</button></a>
                </div>
            </div>
        </div>
    </div>
